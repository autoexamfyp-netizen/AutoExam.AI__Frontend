  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f3f5fb] text-[#121938]">
      ...
      <div className="min-h-screen min-w-0 max-w-full">
        ...
        <div className="box-border flex min-h-screen w-full min-w-0 max-w-full flex-col overflow-x-hidden lg:pl-[248px]">
          <header className="sticky top-0 z-30 flex h-[64px] min-w-0 w-full max-w-full shrink-0 items-center justify-between gap-3 border-b border-[#e7eaf3] bg-white/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-white/85 sm:px-6">
          ...
          <main className="box-border min-w-0 w-full max-w-full flex-1 overflow-x-hidden p-4 sm:p-6 lg:p-8">
            {error ? (
